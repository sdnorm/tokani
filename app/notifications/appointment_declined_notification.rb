class AppointmentDeclinedNotification < ApplicationNotification
  deliver_by :action_cable, format: :to_websocket, channel: "NotificationChannel"
  deliver_by :email, mailer: "AppointmentsMailer", method: :appointment_declined, if: :email_notifications?
  ...
  def email_notifications?
    recipient&.notification_setting&.appointment_declined
  end
end
