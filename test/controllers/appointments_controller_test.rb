...
class AppointmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  #         billing_notes: @appointment.billing_notes,
  #         cancel_reason_code: @appointment.cancel_reason_code,
  #         canceled_by: @appointment.canceled_by,
  #         confirmation_date: @appointment.confirmation_date,
  #         confirmation_notes: @appointment.confirmation_notes,
  #         confirmation_phone: @appointment.confirmation_phone,
  #         details: @appointment.details,
  #         duration: @appointment.duration,
  #         finish_time: @appointment.finish_time,
  #         gender_req: @appointment.gender_req,
  #         home_health_appointment: @appointment.home_health_appointment,
  #         interpreter_type: @appointment.interpreter_type,
