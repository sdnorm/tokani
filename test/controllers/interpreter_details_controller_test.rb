...
class InterpreterDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post interpreter_details_url, params: {interpreter_detail: {gender: @interpreter_detail.gender, interpreter_type: @interpreter_detail.interpreter_type, primary_phone: @interpreter_detail.primary_phone, interpreter_id: @user.id}}
  #   end
  ...
  #   patch interpreter_detail_url(@interpreter_detail), params: {interpreter_detail: {gender: @interpreter_detail.gender, interpreter_type: @interpreter_detail.interpreter_type, primary_phone: @interpreter_detail.primary_phone, interpreter_id: @user.id}}
