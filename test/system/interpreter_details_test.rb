...
class InterpreterDetailsTest < ApplicationSystemTestCase
  ...
  test "creating a Interpreter detail" do
    ...
    fill_in "Gender", with: @interpreter_detail.gender
    fill_in "Interpreter type", with: @interpreter_detail.interpreter_type
    fill_in "Primary phone", with: @interpreter_detail.primary_phone
  ...
  test "updating a Interpreter detail" do
    visit interpreter_detail_url(@interpreter_detail)
  ...
  test "destroying a Interpreter detail" do
    visit edit_interpreter_detail_url(@interpreter_detail)
